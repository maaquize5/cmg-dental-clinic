...
function spinWheel() {
    ...
    let randomPrize = 0;
    const r = Math.random();
    if (r < 0.15) randomPrize = 0;
    else if (r < 0.30) randomPrize = 1;
    else if (r < 0.32) randomPrize = 2; // 2%
    else if (r < 0.67) randomPrize = 3; // 35% ganan Premio consuelo
    else if (r < 0.70) randomPrize = 4; // 3%
    else if (r < 0.98) randomPrize = 5; // 28% ganan Fluorización
    else randomPrize = 6;               // 2%
